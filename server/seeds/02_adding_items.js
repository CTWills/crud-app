...
exports.seed = async function(knex) {
  ...
  await knex('items').insert([
    ...
    {users_id: 2, item_name: 'Scary Costume', description: 'A lot say this costume is the most terrifying one out there. One would say it looks like a kitty.', quantity: 36},
